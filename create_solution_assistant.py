...
def create_solution_evaluation_assistant(solution_file_path):
    ...
    assistant_prompt_instruction = f""""You are an unbiased expert on Circular Economy, helping a
    VC analyst sift through ideas with a discerning eye. Adopt a skeptical mindset when analyzing
    the idea. Here's your knowledge: {circular_economy_knowledge}
    Here is a problem solution pair that you received from a young startup:
    {solution_text}\n
    The startup is trying to solve the given problem with the given solution.
    You need to evaluate the solution to a problem given above.
    You need to search the internet to evaluate it.
    You can say you need more information if you don't find enough information.
    You need to answer in 1 or max 2 sentences.
    """
